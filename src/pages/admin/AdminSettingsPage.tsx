...
interface FormState {
  ...
  contactEmail: string
  contactPhone: string
  deliveryStandard: string // pounds, as typed
    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-8">
        ...
        <section>
          ...
          <p className="mt-1 text-xs text-ink-400">Used to price every basket and order — see the Delivery information page.</p>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <Input
            ...
            <Input
              ...
              hint="Orders at or above this subtotal get free delivery."
            />
          </div>
        </section>
