    ...
    <form role="search" onSubmit={onSubmit} className={className}>
      ...
      <div className="relative">
        <input
          ...
          className="h-10 w-full rounded-full border border-ink-300 bg-white pl-4 pr-10 text-sm text-ink-900 placeholder:text-ink-400 focus-visible:outline-2 focus-visible:outline-accent-500"
        />
        <button
          type="submit"
          aria-label="Search"
